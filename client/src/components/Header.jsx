const Header = () => {
  return (
    <div className="flex grow-1 items-center mx-9 h-20 justify-between">
      ...
      <div className="grow-1 flex gap-2 items-center border rounded-full p-2 px-4 shadow-gray-300 shadow-md">
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="grow-1 flex items-center border rounded-full p-1 gap-2">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
          </svg>
          <div className="rounded-full border p-1 bg-gray-500 overflow-hidden">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 text-white relative top-1">
